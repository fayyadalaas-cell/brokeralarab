...
export default function LearnTradingPage() {
  ...
  return (
    <>
      ...
      <main
        dir="ltr"
        className="mx-auto w-full max-w-7xl px-3 pt-5 pb-10 text-left sm:px-4 md:pt-6"
      >
        ...
        <section className="relative overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm md:rounded-[34px]">
          <div className="absolute inset-x-0 top-0 h-1.5 bg-gradient-to-r from-brand-500 via-blue-500 to-cyan-400" />
          ...
          <div className="grid gap-6 p-5 md:p-8 lg:grid-cols-[1fr_360px] lg:items-center">
            <div>
              ...
              <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                <InternalLink
                  href="/en/learn-trading/how-to-start-trading-from-zero"
                  className="inline-flex min-h-[52px] items-center justify-center rounded-2xl bg-gradient-to-r from-brand-500 to-blue-600 px-6 text-sm font-black text-white shadow-lg shadow-blue-200 transition hover:scale-[1.01] hover:shadow-xl md:text-base"
                >
                  Start from Scratch
                </InternalLink>
        ...
        <section className="mt-5 overflow-hidden rounded-[28px] border border-brand-200 bg-gradient-to-r from-brand-600 via-brand-500 to-cyan-400 p-6 text-center text-white shadow-xl md:p-8">
