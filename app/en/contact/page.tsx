      ...
      <div className="mx-auto max-w-7xl px-4 py-10 md:py-14">
        <header className="mb-8 rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm md:p-8">
          ...
          <p className="max-w-4xl text-lg leading-9 text-slate-600">
            ...
            question about the website, you can contact us using the email below.
          </p>
        </header>
        ...
        <div className="grid gap-6">
          ...
          <Section title="Important Notes Before Contacting Us">
            <p>
              Please make your message clear and specific. If your inquiry relates
              to a particular broker or page, include the relevant name or link so
              we can review it more efficiently.
            </p>

            <p>
              Broker Alarab is a content and comparison website. We are not a
              brokerage firm, we do not manage funds, and we do not execute trades
              on behalf of users.
            </p>
