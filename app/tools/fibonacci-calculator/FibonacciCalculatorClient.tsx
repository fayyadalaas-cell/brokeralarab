              ...
              <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:p-7">
                ...
                <div className="mt-5 hidden overflow-hidden rounded-2xl border border-slate-200 md:block">
                  <table className="w-full text-right text-sm">
                    ...
                    <tbody className="divide-y divide-slate-100">
                      {exampleRows.map((row) => (
                        <tr key={`${row.trend}-${row.level}`} className="transition hover:bg-blue-50">
                          ...
                          <td className="p-4 font-extrabold text-blue-700">{row.value}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
                    ...
                    >
                      <div className="grid grid-cols-2 gap-3 text-sm">
                        ...
                        <div>
                          ...
                          <div className="mt-1 font-extrabold text-blue-700">{row.value}</div>
                        </div>
                      </div>
                    </div>
                  ))}
