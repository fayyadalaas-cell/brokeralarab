...
export default function PipCalculatorClient() {
        ...
        >
          ...
          <div className="grid items-start gap-6 p-5 sm:p-8 lg:grid-cols-[1fr_0.9fr] lg:p-10">
            ...
            <div className="rounded-[1.25rem] border border-slate-200 bg-slate-50 p-4 sm:rounded-[2rem] sm:p-6 lg:self-start">
             ...
             <div className="hidden lg:block mt-6 rounded-2xl border border-brand-100 bg-white p-4 shadow-sm">
  ...
  <div className="grid gap-2 sm:grid-cols-2">
    <a
      ...
      className="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-center text-sm font-bold text-slate-800 transition hover:border-blue-300 hover:bg-brand-50 hover:text-brand-600"
    >
      حاسبة إدارة المخاطر
    </a>
