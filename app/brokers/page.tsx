...
export const metadata: Metadata = {
  title: "تقييم شركات التداول وفتح حساب حقيقي | بروكر العرب",
  description:
    "تصفح تقييم شركات التداول الموثوقة، وقارن بين التراخيص والإيداع والمنصات والحساب الإسلامي، ثم اختر الوسيط المناسب لفتح حساب حقيقي بثقة.",
  alternates: {
    canonical: "/brokers",
  },
  openGraph: {
    title: "تقييم شركات التداول وفتح حساب حقيقي | بروكر العرب",
    description:
      "صفحة احترافية لتقييم شركات التداول مع جدول منظم وروابط مباشرة لعرض التقييم وفتح حساب حقيقي عند توفرها.",
    url: "/brokers",
