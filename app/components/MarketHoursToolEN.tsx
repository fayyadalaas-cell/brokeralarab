...
export default function MarketHoursToolEN() {
  const [now, setNow] =
  ...
  return (
    <div className="overflow-hidden rounded-[30px] border border-slate-200 bg-white shadow-[0_18px_50px_rgba(15,23,42,0.065)]">
        ...
        <div className="sm:hidden">
          ...
          >
            ...
            <div className="flex items-center gap-2.5">
              ...
              >
                {openMarkets.length > 0
                  ? `${openMarkets.length} ${openMarkets.length === 1 ? "major market is" : "major markets are"} open now`
                  : "Major markets are closed now"}
              </span>
        ...
        <div className="hidden items-center justify-between gap-6 sm:flex">
          ...
          <div>
            ...
            <p className="mt-1.5 text-[12px] font-semibold text-slate-500">
              Live status and market times converted automatically to your local time zone
            </p>
            ...
            <div className="p-3.5">
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="flex min-w-0 items-center gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <p
                      dir="ltr"
                      className="mt-0.5 text-left text-[9px] font-bold text-slate-500"
                    >
                      {
                        item.market
                          .shortName
              ...
              <div className="mt-4 grid grid-cols-2 gap-3 border-t border-slate-100 pt-3.5">
                ...
                <div>
                  ...
                  <div
                    dir="ltr"
                    className="mt-1 text-left text-[15px] font-black text-brand-600"
                  >
                    {getChangeTime(
                      now,
                ...
                <div>
                  ...
                  <div
                    className={`mt-1 text-left text-[13px] font-black leading-6 ${
                      item.isOpen
                        ? "text-emerald-700"
                        : "text-slate-900"
                    }`}
        ...
        <div className="sm:hidden">
          ...
          <div className="mb-4">
            ...
            <p className="mt-1.5 text-[10px] font-semibold leading-5 text-slate-500">
              Each market is shown in your local time automatically.
            </p>
              ...
              return (
                ...
                >
                  ...
                  <div className="grid grid-cols-2 border-t border-slate-100">
                    ...
                    <div className="border-r border-slate-100 px-3.5 py-3">
                    ...
                    <div className="relative h-9 overflow-hidden rounded-[11px] border border-slate-200 bg-slate-50">
                      ...
                      <div className="absolute inset-0 grid grid-cols-4">
                        ...
                        {Array.from({ length: 4 }).map((_, index) => (
                          <div
                            key={index}
                            className="border-r border-slate-200/80 last:border-0"
                          />
                        ))}
        ...
        <div className="hidden sm:block">
          ...
          <div className="mb-5 flex items-end justify-between gap-5">
            ...
            <div>
              ...
              <p className="mt-1 text-[11px] font-semibold text-slate-500">
                All timeline hours are shown in your local time zone.
              </p>
            ...
            <div className="rounded-xl bg-brand-50 px-3 py-2 text-left">
              ...
              <div className="mt-0.5 text-[13px] font-black text-brand-600">
          ...
          <div className="overflow-hidden">
            ...
            <div>
              ...
              <div className="ml-[125px] grid grid-cols-8 text-center">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          ...
                          <div className="mt-0.5 text-[7.5px] font-bold text-slate-400">
                            {market.shortName}
                          </div>
                      ...
                      <div className="relative h-11 overflow-hidden rounded-[12px] border border-slate-200 bg-slate-50">
                        ...
                        <div className="absolute inset-0 grid grid-cols-8">
                          ...
                          {Array.from({
                            ...
                            <div
                              key={index}
                              className="border-r border-slate-200/75 last:border-0"
                            />
                          ))}
      ...
      <div className="border-t border-amber-100 bg-amber-50/70 px-4 py-3.5 text-[10px] font-semibold leading-6 text-amber-900 sm:px-6 sm:text-[11px]">
        ...
        Status is based on regular weekday trading hours. Exchanges may close or operate shorter sessions on market holidays and scheduled early-close days.
