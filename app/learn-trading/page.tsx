 ...
 const collectionSchema = {
  ...
  return (
    <>
      ...
      <main
        dir="rtl"
        className="mx-auto w-full max-w-[1560px] px-3 pt-5 pb-0 text-right sm:px-4 md:pt-6"
      >
        ...
        <section className="relative overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm md:rounded-[34px]">
         ...
         <div className="grid gap-6 p-5 md:p-8 lg:grid-cols-[minmax(0,1fr)_320px] lg:items-center lg:gap-8">
            <div>
              ...
              <>
 <h1 className="w-full text-[38px] font-black leading-tight text-slate-950 md:text-[54px]">
  دليل تعلم التداول
</h1>
</>

             {/* Desktop */}
<p className="mt-5 hidden w-full text-[15px] font-medium leading-8 text-slate-600 md:block md:text-lg md:leading-9">
  ابدأ رحلتك في تعلم التداول من الصفر من خلال دروس مبسطة ومنظمة تساعدك
  على فهم كيفية عمل الأسواق، وأساسيات الفوركس، والسبريد، والرافعة المالية،
  والهامش، وحجم الصفقة. تعلّم إدارة المخاطر واستخدام وقف الخسارة، ثم استفد
  من حاسبات التداول العملية لفهم تكلفة الصفقة قبل تنفيذها. كما يساعدك هذا
  الدليل على قراءة المؤشرات الاقتصادية، مقارنة شركات التداول، واختيار وسيط
  موثوق من حيث الترخيص والرسوم والمنصات قبل الانتقال إلى حساب حقيقي.
</p>

{/* Mobile */}
<p className="mt-5 block text-[15px] leading-8 text-slate-600 md:hidden">
  ابدأ رحلتك في تعلم التداول من الصفر من خلال دروس مبسطة وأدوات مجانية تساعدك
  على فهم الأسواق، وإدارة المخاطر، واختيار وسيط تداول موثوق قبل فتح حساب حقيقي.
</p>
