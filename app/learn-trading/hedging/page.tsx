...
const hedgingTypes = [
  {
    ...
    subtitle: "Full Hedge",
    description:
      "يتم فتح مركز معاكس مساوٍ تقريبًا لحجم الصفقة الأصلية على الأداة نفسها، بهدف تثبيت التعرض مؤقتًا وتقليل أثر حركة السعر.",
    points: [
      "يقلل صافي التعرض للسوق بصورة كبيرة.",
  ...
  },
  {
    ...
    description:
      "يتم فتح صفقة معاكسة بحجم أصغر من المركز الأصلي، لتقليل جزء من التعرض مع الاحتفاظ بجزء من الاستفادة إذا استمر الاتجاه.",
    points: [
      "يخفض المخاطرة دون إلغائها بالكامل.",
      "يوفر مرونة أكبر في إدارة الصفقة.",
      "يحتاج إلى حساب دقيق للأحجام.",
    ],
    badge: "مرونة أكبر",
  },
  {
    ...
    description:
      "يستخدم المتداول أداة أخرى ترتبط بحركة الأصل الأصلي، مثل زوج عملات أو مؤشر أو عقد مختلف، بهدف موازنة جزء من المخاطر.",
    points: [
      "يفيد عندما لا تتوفر تغطية مباشرة.",
      "يعتمد على قوة الارتباط بين الأدوات.",
      "قد يفشل إذا تغير الارتباط في السوق.",
    ],
...
const hedgingFactors = [
  {
    ...
    description:
      "كلما اقترب حجم الصفقة المعاكسة من حجم المركز الأصلي، انخفض صافي التعرض للسوق. أما الحجم الأصغر فيوفر تغطية جزئية فقط.",
  },
  {
    icon: "💸",
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "الهيدج الكامل يستخدم مركزًا معاكسًا مساويًا تقريبًا للمركز الأصلي، بينما يستخدم الهيدج الجزئي مركزًا أصغر لتقليل جزء فقط من التعرض.",
  },
  {
...
const relatedGuides = [
  ...
  },
  {
    title: "ما هو اللوت؟",
    description:
      "افهم حجم الصفقة وقيمة النقطة وعلاقة اللوت بمقدار التعرض والمخاطرة.",
          ...
          <article className="w-full min-w-0 space-y-7">
            ...
            >
              <SectionHeading
                number="01"
                eyebrow="معنى الهيدج"
                title="كيف تقلل التغطية صافي التعرض لحركة السوق؟"
              />
              ...
              <div className="mt-4 space-y-3 text-[14px] font-medium leading-7 text-slate-600 sm:mt-5 sm:space-y-4 sm:text-base sm:leading-8">
                ...
                <p>
                  الهدف من الهيدج ليس تحقيق ربح مضمون أو حذف الخسارة، بل
                  تعديل صافي التعرض للسوق. عند تنفيذ تغطية كاملة على نفس
                  الأداة وبحجم مساوٍ، يصبح الربح الناتج عن أحد المركزين قريبًا
                  من الخسارة الناتجة عن المركز الآخر، قبل احتساب التكاليف.
                </p>
              </div>
              ...
              <div className="mt-4 grid gap-2 sm:mt-6 sm:grid-cols-3 sm:gap-3">
                <MiniDefinition
                  label="Exposure"
                  title="صافي التعرض"
                  description="مقدار تأثر الحساب بحركة السعر بعد جمع المراكز المفتوحة."
                />
            ...
            >
              ...
              <div className="mt-6 overflow-hidden rounded-[22px] border border-slate-200">
                <div className="bg-slate-950 px-4 py-3 text-center text-sm font-black text-white sm:text-base">
                  صافي التعرض = حجم مركز الشراء − حجم مركز البيع
                </div>
