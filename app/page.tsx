...
export const metadata: Metadata = {
  ...
  description:
  "قارن أفضل شركات التداول لعام 2026 من خلال مراجعات مستقلة ومقارنات شاملة تشمل التراخيص، الرسوم، السبريد، أنواع الحسابات، منصات التداول، وطرق السحب والإيداع لاختيار الوسيط المناسب بثقة.",
  keywords: [
    "بروكر العرب",
    "تقييم شركات التداول",
