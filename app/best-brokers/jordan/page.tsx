...
export const metadata: Metadata = {
  ...
  description:
    "تعرف على أفضل شركات التداول في الأردن لعام 2026، مع شرح أهم المعايير مثل الحساب الإسلامي، التراخيص، الإيداع، والمنصات المناسبة للمبتدئين والمحترفين.",
  alternates: {
  ...
  openGraph: {
    title: "أفضل شركات التداول في الأردن 2026 | بروكر العرب",
    description:
      "دليل شامل يساعدك على اختيار أفضل شركة تداول في الأردن بناءً على الترخيص، الحساب الإسلامي، الإيداع، والمنصات.",
