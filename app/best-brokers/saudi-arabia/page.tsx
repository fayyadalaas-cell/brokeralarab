...
export const metadata: Metadata = {
  ...
  description:
    "تعرف على أفضل شركات التداول في السعودية لعام 2026، مع شرح أهم المعايير مثل الحساب الإسلامي، التراخيص، الإيداع، والمنصات المناسبة للمبتدئين والمحترفين.",
  alternates: {
    canonical: "/best-brokers/saudi-arabia",
  },
  openGraph: {
    title: "أفضل شركات الفوركس في السعودية | بروكر العرب",
    description:
      "دليل شامل يساعدك على اختيار أفضل شركة تداول في السعودية بناءً على الترخيص، الحساب الإسلامي، الإيداع، والمنصات.",
