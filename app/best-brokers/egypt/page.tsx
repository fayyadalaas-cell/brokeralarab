...
export const metadata: Metadata = {
  ...
  description:
    "اكتشف أفضل شركات التداول في مصر لعام 2026 مع مقارنة التراخيص والمنصات والحساب الإسلامي والحد الأدنى للإيداع لاختيار الوسيط المناسب.",
  keywords: [
    "أفضل شركات التداول في مصر",
    "أفضل شركات الفوركس في مصر",
    "شركات تداول موثوقة في مصر",
    "أفضل وسيط تداول في مصر",
    "الحساب الإسلامي",
    "بروكر العرب",
  ],
  alternates: {
    canonical: "https://brokeralarab.com/best-brokers/egypt",
  },
  openGraph: {
    title: "أفضل شركات التداول في مصر 2026 | بروكر العرب",
    description:
      "دليل عربي شامل يساعدك على اختيار أفضل شركة تداول في مصر بناءً على الترخيص والمنصات والحساب الإسلامي والإيداع.",
