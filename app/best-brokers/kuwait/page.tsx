...
export const metadata: Metadata = {
  title: "أفضل شركات التداول في الكويت 2026 | بروكر العرب",
  description:
    "تعرف على أفضل شركات التداول في الكويت لعام 2026، مع شرح أهم المعايير مثل الحساب الإسلامي، التراخيص، الإيداع، والمنصات المناسبة للمبتدئين والمحترفين.",
  alternates: {
  ...
  openGraph: {
    title: "أفضل شركات التداول في الكويت 2026 | بروكر العرب",
    description:
      "دليل شامل يساعدك على اختيار أفضل شركة تداول في الكويت بناءً على الترخيص، الحساب الإسلامي، الإيداع، والمنصات.",
...
const { data: brokers } = await supabase
  ...
  <div className="mb-6 text-center">
    ...
    <p className="mt-2 text-slate-600">
      هذه قائمة مختارة من الوسطاء الأكثر شعبية بين المتداولين في الكويت.
    </p>
  </div>
  ...
  <div className="flex gap-2">
    ...
    >
      ...
      <section className="mx-auto max-w-7xl px-4 pb-8">
        <div className="grid gap-4 lg:grid-cols-[1.35fr_0.65fr]">
          <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm md:p-8">
            <h2 className="text-2xl font-extrabold text-slate-900 md:text-3xl">
              كيف اخترنا أفضل شركات التداول في الكويت؟
            </h2>

            <div className="mt-5 space-y-5 text-base leading-8 text-slate-700">
              <p>
                اختيار أفضل شركة تداول في الكويت لا ينبغي أن يعتمد فقط على اسم
              ...
              <p>
                ركزنا على العناصر الأكثر أهمية بالنسبة للمتداولين في الكويت،
      ...
      <section className="mx-auto max-w-7xl px-4 pb-8">
        <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm md:p-8">
          <h2 className="text-2xl font-extrabold text-slate-900 md:text-3xl">
            لماذا يهتم المتداولون في الكويت بالحساب الإسلامي؟
          </h2>

          <div className="mt-5 space-y-5 text-base leading-8 text-slate-700">
            <p>
              من أكثر الأمور التي يبحث عنها المستخدم عند اختيار شركة تداول في
              الكويت هي إمكانية فتح حساب إسلامي. ويرجع ذلك إلى رغبة شريحة
          ...
          <div className="grid gap-5 md:grid-cols-[1fr_auto] md:items-center">
            <div>
              ...
              <p className="mt-3 max-w-3xl text-sm leading-8 text-blue-50 md:text-base">
                أفضل طريقة لاختيار شركة تداول في الكويت هي أن تبدأ بالمقارنة
      ...
      <section className="mx-auto max-w-7xl px-4 pb-14">
        <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm md:p-8">
          <h2 className="text-2xl font-extrabold text-slate-900 md:text-3xl">
            الأسئلة الشائعة حول أفضل شركات التداول في الكويت
          </h2>

          <div className="mt-8 space-y-4">
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
              <h3 className="text-lg font-bold text-slate-900">
                ما أفضل شركة تداول في الكويت؟
              </h3>
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
              ...
              <p className="mt-2 leading-8 text-slate-700">
                نعم، بالنسبة إلى كثير من المتداولين في الكويت يعتبر الحساب
