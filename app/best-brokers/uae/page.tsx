...
export const metadata: Metadata = {
  title: "أفضل شركات التداول في الامارات العربية المتحدة 2026 | بروكر العرب",
  description:
    "تعرف على أفضل شركات التداول في الامارات العربية المتحدة لعام 2026، مع شرح أهم المعايير مثل الحساب الإسلامي، التراخيص، الإيداع، والمنصات المناسبة للمبتدئين والمحترفين.",
  alternates: {
  ...
  openGraph: {
    title: "أفضل شركات التداول في الامارات العربية المتحدة 2026 | بروكر العرب",
    description:
      "دليل شامل يساعدك على اختيار أفضل شركة تداول في الامارات العربية المتحدة بناءً على الترخيص، الحساب الإسلامي، الإيداع، والمنصات.",
