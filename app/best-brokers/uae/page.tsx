...
export const metadata: Metadata = {
  title: "أفضل شركات التداول في الإمارات 2026 | بروكر العرب",
  description:
    "اكتشف أفضل شركات التداول في الإمارات لعام 2026 مع مقارنة التراخيص والمنصات والحساب الإسلامي والحد الأدنى للإيداع لاختيار الوسيط المناسب.",
  keywords: [
    "أفضل شركات التداول في الإمارات",
    "أفضل شركات الفوركس في الإمارات",
    "شركات تداول موثوقة في الإمارات",
    "أفضل وسيط تداول في الإمارات",
    "الحساب الإسلامي",
    "بروكر العرب",
  ],
  alternates: {
    canonical: "https://brokeralarab.com/best-brokers/uae",
  },
  openGraph: {
    title: "أفضل شركات التداول في الإمارات 2026 | بروكر العرب",
    description:
      "دليل عربي شامل يساعدك على اختيار أفضل شركة تداول في الإمارات بناءً على الترخيص والمنصات والحساب الإسلامي والإيداع.",
...
const { data: brokers } = await supabase
        ...
        <div className="mx-auto max-w-7xl px-4 py-12 md:py-16 lg:py-20">
          <div className="mx-auto max-w-4xl text-center">
            <span className="mb-4 inline-flex rounded-full border border-blue-200 bg-blue-50 px-4 py-1.5 text-sm font-bold text-blue-700">
              دليل محدث للمتداولين في الامارات العربية المتحدة
            </span>

            <h1 className="text-3xl font-extrabold leading-tight text-slate-900 md:text-5xl">
              أفضل شركات التداول في الامارات العربية المتحدة
            </h1>

            <p className="mx-auto mt-5 max-w-3xl text-base leading-8 text-slate-600 md:text-lg">
              إذا كنت تبحث عن أفضل شركات التداول في الامارات العربية المتحدة، فهذه الصفحة
  ...
  <div className="mb-6 text-center">
    ...
    <p className="mt-2 text-slate-600">
      هذه قائمة مختارة من الوسطاء الأكثر شعبية بين المتداولين في الامارات العربية المتحدة.
    </p>
  </div>
  ...
  <div className="flex gap-2">
    ...
    >
      ...
      <section className="mx-auto max-w-7xl px-4 pb-8">
        <div className="grid gap-4 lg:grid-cols-[1.35fr_0.65fr]">
          <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm md:p-8">
            <h2 className="text-2xl font-extrabold text-slate-900 md:text-3xl">
              كيف اخترنا أفضل شركات التداول في الامارات العربية المتحدة؟
            </h2>

            <div className="mt-5 space-y-5 text-base leading-8 text-slate-700">
              <p>
                اختيار أفضل شركة تداول في الامارات العربية المتحدة لا ينبغي أن يعتمد فقط على اسم
              ...
              <p>
                ركزنا على العناصر الأكثر أهمية بالنسبة للمتداولين في الامارات العربية المتحدة،
      ...
      <section className="mx-auto max-w-7xl px-4 pb-8">
        <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm md:p-8">
          <h2 className="text-2xl font-extrabold text-slate-900 md:text-3xl">
            لماذا يهتم المتداولون في الامارات العربية المتحدة بالحساب الإسلامي؟
          </h2>

          <div className="mt-5 space-y-5 text-base leading-8 text-slate-700">
            <p>
              من أكثر الأمور التي يبحث عنها المستخدم عند اختيار شركة تداول في
              الامارات العربية المتحدة هي إمكانية فتح حساب إسلامي. ويرجع ذلك إلى رغبة شريحة
          ...
          <div className="grid gap-5 md:grid-cols-[1fr_auto] md:items-center">
            <div>
              ...
              <p className="mt-3 max-w-3xl text-sm leading-8 text-blue-50 md:text-base">
                أفضل طريقة لاختيار شركة تداول في الامارات العربية المتحدة هي أن تبدأ بالمقارنة
      ...
      <section className="mx-auto max-w-7xl px-4 pb-14">
        <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm md:p-8">
          <h2 className="text-2xl font-extrabold text-slate-900 md:text-3xl">
            الأسئلة الشائعة حول أفضل شركات التداول في الامارات العربية المتحدة
          </h2>

          <div className="mt-8 space-y-4">
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
              <h3 className="text-lg font-bold text-slate-900">
                ما أفضل شركة تداول في الامارات العربية المتحدة؟
              </h3>
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
              ...
              <p className="mt-2 leading-8 text-slate-700">
                نعم، بالنسبة إلى كثير من المتداولين في الامارات العربية المتحدة يعتبر الحساب
